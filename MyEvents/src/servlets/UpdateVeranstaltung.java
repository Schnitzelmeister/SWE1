...
public class UpdateVeranstaltung extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		try{
			...
			Integer veranstaltungid= Integer.parseInt(request.getParameter("id"));
			response.sendRedirect("MyEvents/veranstalter/main.jsp?id="+veranstaltungid + "&error="+e.getMessage());
		}
		catch(Exception e){
			Integer veranstaltungid= Integer.parseInt(request.getParameter("id"));
			response.sendRedirect("MyEvents/vernatslter/main.jsp?id="+veranstaltungid + "&error=Ein Fehler ist aufgetreten.");
		}
	}
